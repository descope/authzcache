...
require (
	github.com/descope/common v0.0.9-0.20250909200942-1e9ce98603cb
	...
	github.com/descope/protoc-gen-validate v1.6.5
...
require (
	...
	github.com/descope/authzservice v0.0.0-20250909215209-3633b6248c39
